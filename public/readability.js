            ...
            readability.ajax(pageUrl, {
                success: function(r) {
                  ...
                  var page = document.createElement("DIV");
                     ...
                     * appending.
                     * â€¢ Remove any script tags. Swap and reswap newlines with
                     *   a unicode character because multiline regex doesn't work
                     *    in javascript.
                     * â€¢ Turn any noscript tags into divs so that we can parse
                     *    them. This allows us to find any next page links
                     *    hidden via javascript.
                     * â€¢ Turn all double br's into p's - was handled by
